...
If you don't have your own keys head up to the aws [https://console.aws.amazon.com](web page) and go to 
Services -> IAM -> Users and click on Security Credentials tab.
